...
static const testspec tests[] = {
    ...
    { "bufchain: Basic Operations", "buftest", "basic" },
    { "bufchain: Peek", "buftest", "peek" },
    { "bufchain: Skip", "buftest", "skip" },
    { "bufchain: Zero-Copy Read", "buftest", "zerocopy_read" },
    { "bufchain: Zero-Copy Write", "buftest", "zerocopy_write" },
    { "bufchain: Ring Buffer Wraparound", "buftest", "wraparound" },
    { "bufchain: Multi-Segment Operations", "buftest", "multisegment" },
