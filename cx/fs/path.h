...
// Internal function - use pathJoin() macro instead
...
enum PathMatchFlags {
    ...
    PATH_Smart           = 4,   // Enable smart matching mode:
                      //   Patterns starting with / match full paths (like PATH_LeadingDir)
                      //   Patterns without leading / match only the filename component
