...
bool VFSVFSFile_read(_In_ VFSVFSFile* self, _Out_writes_bytes_to_(sz, *bytesread) void* buf,
...
bool VFSVFSFile_write(_In_ VFSVFSFile* self, _In_reads_bytes_(sz) const void* buf, size_t sz,
