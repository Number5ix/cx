...
#define htInit(out, keytype, valtype, initsz, flags) _htInit(out, stFullType(keytype), stFullType(valtype), initsz, flags)
...
#define htInsert(htbl, ktype, key, vtype, val, flags) _htInsertChecked(htbl, stCheckedArg(ktype, key), stCheckedArg(vtype, val), flags)
// Consumes *value*, not key
#define htInsertC(htbl, ktype, key, vtype, val, flags) _htInsertCheckedC(htbl, stCheckedArg(ktype, key), stCheckedPtrArg(vtype, val), flags | HTINT_Consume)
...
#define htFind(htbl, ktype, key, vtype, val_copy_out, flags) _htFindChecked(htbl, stCheckedArg(ktype, key), stCheckedPtrArg(vtype, val_copy_out), flags)
