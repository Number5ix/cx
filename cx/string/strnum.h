...
_Success_(return) bool strToInt32(_Out_ int32 *out, _In_opt_ strref s, int base, bool strict);
_Success_(return) bool strToUInt32(_Out_ uint32 *out, _In_opt_ strref s, int base, bool strict);
_Success_(return) bool strToInt64(_Out_ int64 *out, _In_opt_ strref s, int base, bool strict);
_Success_(return) bool strToUInt64(_Out_ uint64 *out, _In_opt_ strref s, int base, bool strict);
...
_Success_(return) bool strToFloat32(_Out_ float32 *out, _In_opt_ strref s, bool strict);
_Success_(return) bool strToFloat64(_Out_ float64 *out, _In_opt_ strref s, bool strict);
