...
// A log destination should try to keep messages with the same batchid together, i.e. not split
// logfiles across the batch if possible. The batch ID should be treated as opaque and for
// comparison purposes only; it has no particular ordering.
