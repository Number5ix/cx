...
bool suidDecodeBytes(SUID* out, const char buf[26])
{
    ...
    out->high = ((uint64)dec[(uint8)buf[0]] << 61) | ((uint64)dec[(uint8)buf[1]] << 56) |
        ((uint64)dec[(uint8)buf[2]] << 51) | ((uint64)dec[(uint8)buf[3]] << 46) |
        ((uint64)dec[(uint8)buf[4]] << 41) | ((uint64)dec[(uint8)buf[5]] << 36) |
        ((uint64)dec[(uint8)buf[6]] << 31) | ((uint64)dec[(uint8)buf[7]] << 26) |
        ((uint64)dec[(uint8)buf[8]] << 21) | ((uint64)dec[(uint8)buf[9]] << 16) |
        ((uint64)dec[(uint8)buf[10]] << 11) | ((uint64)dec[(uint8)buf[11]] << 6) |
        ((uint64)dec[(uint8)buf[12]] << 1) | ((uint64)dec[(uint8)buf[13]] >> 4);
    out->low = ((uint64)dec[(uint8)buf[13]] << 60) | ((uint64)dec[(uint8)buf[14]] << 55) |
        ((uint64)dec[(uint8)buf[15]] << 50) | ((uint64)dec[(uint8)buf[16]] << 45) |
        ((uint64)dec[(uint8)buf[17]] << 40) | ((uint64)dec[(uint8)buf[18]] << 35) |
        ((uint64)dec[(uint8)buf[19]] << 30) | ((uint64)dec[(uint8)buf[20]] << 25) |
        ((uint64)dec[(uint8)buf[21]] << 20) | ((uint64)dec[(uint8)buf[22]] << 15) |
        ((uint64)dec[(uint8)buf[23]] << 10) | ((uint64)dec[(uint8)buf[24]] << 5) |
        dec[(uint8)buf[25]];
