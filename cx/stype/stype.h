...
///
/// Object classes generated by the cxautogen tool can be used as type names directly
/// in container operations. `MyClass` is a valid type name for `saInit`, `saPush`,
/// `htInsert`, and similar APIs. The named class type is an alias for `object`, so
/// all class instances share the same underlying descriptor and containers remain
/// polymorphic: a container initialized with `MyBase` will accept `MyDerived`
/// instances, since the type identity is the same throughout the object hierarchy.
///
/// When a named class is used at an insertion site, the argument is checked against
/// the expected class at compile time (and in debug builds at runtime). Compare:
///
/// @code
...
/// @endcode
///
/// The storage type for a named class (`SType_MyClass`) is `MyClass*`, so accessors
/// such as `hteVal` return the correct pointer type without an explicit cast.
///
...
#define objInstCheckClass(cls, o) (unused_noeval((o) && &((o)->_is_##cls)), (cls*)(o))
#define objInstCheckClassPtr(cls, o) \
    (unused_noeval((o != NULL) && (*o) && &((*o)->_is_##cls)), (cls**)(o))
...
#define objWeakRefCheckClass(cls, o) \
    (unused_noeval((o) && &((o)->_is_##cls##_WeakRef)), (cls##_WeakRef*)(o))
#define objWeakRefCheckClassPtr(cls, o) \
    (unused_noeval((o) && (*o) && &((*o)->_is_##cls##_WeakRef)), (cls##_WeakRef**)(o))
